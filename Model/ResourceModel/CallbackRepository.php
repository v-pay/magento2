...
use VirtualPay\Payment\Api\Data\CallbackInterfaceFactory;
use VirtualPay\Payment\Api\Data\CallbackSearchResultsInterfaceFactory;
use VirtualPay\Payment\Api\CallbackRepositoryInterface;
use VirtualPay\Payment\Model\ResourceModel\Callback as ResourceCallback;
use VirtualPay\Payment\Model\ResourceModel\Callback\CollectionFactory as CallbackCollectionFactory;
...
class CallbackRepository implements CallbackRepositoryInterface
{
    ...
    public function save(
        \VirtualPay\Payment\Api\Data\CallbackInterface $callback
    ) {
        try {
    ...
    public function getList(
        ...
        $this->extensionAttributesJoinProcessor->process(
            $collection,
            \VirtualPay\Payment\Api\Data\CallbackInterface::class
        );
